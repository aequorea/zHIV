...
Having said all of that, the idea of blocking the interaction between gp120 and CD4 is fairly non-controversial. That glycosylation might improve performance is somewhat speculative. In other words, there may be a reason for doing the experiment. Does glycosylation of an HIV blocking molecule reduce the probability of infection?
